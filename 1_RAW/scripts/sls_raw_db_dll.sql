...
CREATE TABLE IF NOT EXISTS `sls_raw`.`lens` (
  ...
  `name` TINYTEXT NULL DEFAULT NULL,
  `lens_category_id` INT(11) NOT NULL,
  `Category` TINYTEXT NULL DEFAULT NULL,
  `FMin` DOUBLE NULL DEFAULT NULL,
  `FMax` TINYTEXT NULL DEFAULT NULL,
  `AMax` DOUBLE NULL DEFAULT NULL,
  `AMin` TINYTEXT NULL DEFAULT NULL,
  `FocusMin` TINYTEXT NULL DEFAULT NULL,
  `Filter` TINYTEXT NULL DEFAULT NULL,
  PRIMARY KEY (`lens_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `sls_raw`.`lens_category` (
  `lens_category_id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sls_raw`.`sales` (
  ...
  `lens_id` INT(11) NULL DEFAULT NULL,
  `sales_channel_id` INT(11) NULL DEFAULT NULL,
